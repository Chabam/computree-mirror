...
BOOL LASwriteItemCompressed_POINT10_v1::init(const U8* item, U32&)
{
  U32 i;
...
inline BOOL LASwriteItemCompressed_POINT10_v1::write(const U8* item, U32&)
{
...
BOOL LASwriteItemCompressed_GPSTIME11_v1::init(const U8* item, U32&)
{
  /* init state */
  last_gpstime_diff = 0;
...
inline BOOL LASwriteItemCompressed_GPSTIME11_v1::write(const U8* item, U32&)
{
...
BOOL LASwriteItemCompressed_RGB12_v1::init(const U8* item, U32&)
{
  /* init state */
...
inline BOOL LASwriteItemCompressed_RGB12_v1::write(const U8* item, U32&)
{
...
BOOL LASwriteItemCompressed_WAVEPACKET13_v1::init(const U8* item, U32&)
{
  /* init state */
  last_diff_32 = 0;
...
inline BOOL LASwriteItemCompressed_WAVEPACKET13_v1::write(const U8* item, U32&)
{
...
BOOL LASwriteItemCompressed_BYTE_v1::init(const U8* item, U32&)
{
  /* init state */
...
inline BOOL LASwriteItemCompressed_BYTE_v1::write(const U8* item, U32&)
{
  U32 i;
  for (i = 0; i < number; i++)
  {
