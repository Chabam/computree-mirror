...
BOOL LASreadItemCompressed_POINT10_v2::init(const U8* item, U32&)
{
  U32 i;
...
inline void LASreadItemCompressed_POINT10_v2::read(U8* item, U32&)
{
  U32 r, n, m, l;
  U32 k_bits;
  I32 median, diff;
...
BOOL LASreadItemCompressed_GPSTIME11_v2::init(const U8* item, U32&)
{
  /* init state */
  last = 0, next = 0;
...
BOOL LASreadItemCompressed_RGB12_v2::init(const U8* item, U32&)
{
  /* init state */
...
inline void LASreadItemCompressed_RGB12_v2::read(U8* item, U32&)
{
  U8 corr;
  I32 diff = 0;
...
BOOL LASreadItemCompressed_BYTE_v2::init(const U8* item, U32&)
{
  U32 i;
  /* init state */
...
inline void LASreadItemCompressed_BYTE_v2::read(U8* item, U32&)
{
  U32 i;
  I32 value;
  for (i = 0; i < number; i++)
