...
BOOL LASwriteItemCompressed_POINT10_v2::init(const U8* item, U32&)
{
  U32 i;
...
inline BOOL LASwriteItemCompressed_POINT10_v2::write(const U8* item, U32&)
{
...
BOOL LASwriteItemCompressed_GPSTIME11_v2::init(const U8* item, U32&)
{
  /* init state */
  last = 0, next = 0;
...
BOOL LASwriteItemCompressed_RGB12_v2::init(const U8* item, U32&)
{
  /* init state */
...
inline BOOL LASwriteItemCompressed_RGB12_v2::write(const U8* item, U32&)
{
  I32 diff_l = 0;
  I32 diff_h = 0;
  I32 corr;
...
BOOL LASwriteItemCompressed_BYTE_v2::init(const U8* item, U32&)
{
  U32 i;
  /* init state */
...
inline BOOL LASwriteItemCompressed_BYTE_v2::write(const U8* item, U32&)
{
  U32 i;
  I32 diff;
  for (i = 0; i < number; i++)
