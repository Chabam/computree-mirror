...
BOOL LASreadItemCompressed_POINT10_v1::init(const U8* item, U32&)
{
  U32 i;
...
inline void LASreadItemCompressed_POINT10_v1::read(U8* item, U32&)
{
...
BOOL LASreadItemCompressed_GPSTIME11_v1::init(const U8* item, U32&)
{
  /* init state */
  last_gpstime_diff = 0;
...
inline void LASreadItemCompressed_GPSTIME11_v1::read(U8* item, U32&)
{
  I32 multi;
...
BOOL LASreadItemCompressed_RGB12_v1::init(const U8* item, U32&)
{
  /* init state */
...
inline void LASreadItemCompressed_RGB12_v1::read(U8* item, U32&)
{
...
BOOL LASreadItemCompressed_WAVEPACKET13_v1::init(const U8* item, U32&)
{
  /* init state */
  last_diff_32 = 0;
...
inline void LASreadItemCompressed_WAVEPACKET13_v1::read(U8* item, U32&)
{
...
BOOL LASreadItemCompressed_BYTE_v1::init(const U8* item, U32&)
{
  /* init state */
...
inline void LASreadItemCompressed_BYTE_v1::read(U8* item, U32&)
{
  U32 i;
  for (i = 0; i < number; i++)
  {
