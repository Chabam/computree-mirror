...
protected:
    ...
    template<typename... Type> friend class CT_ItemDrawableCollectionBuilderT;
    ...
    /**
     * @brief Returns the list of results. Use this method in your "compute" method.
     */
    QList<CT_ResultGroup *> getInputResults() const;

    /**
     * @brief Returns the list of results sorted by INPUT models. Use this method in your "compute" method.
     */
    QList<CT_InResultsByModel*> getInputResultsSortedByModels() const;

    /**
     * @brief Returns the list of results that correspond to the INPUT model passed in
    ...
    /**
     * @brief Called to allow the step to create OUTPUT models.
     */
     ...
     */
    Q_DECL_DEPRECATED bool addOutResultModel(CT_OutAbstractResultModel *model);
    ...
    /**
     * @brief Create a new OUTPUT result model and add it to the list of out model.
     *
    ...
    /**
     * @brief Create a new OUTPUT result model that represent a copy of a result of another step (a possibility
    ...
    /**
     * @brief Returns the result that correspond to the OUTPUT model name passed in
     *        parameter. Use this method in your "compute" method.
    ...
    /**
     * @brief Returns the result that correspond to the OUTPUT model passed in
     *        parameter. Use this method in your "compute" method.
...
public:
     ...
     * @warning Not intended for direct use by plugin developper
     */
    QList<CT_InAbstractResultModel*> getInResultsModel() const;

    /**
     * @brief Return OUT models of the step (not used in turns but just for information)
     * @warning Not intended for direct use by plugin developper
     */
    QList<CT_OutAbstractResultModel*> getOutResultsModel() const;
     ...
     */
    template<class T>
    T* getPluginAs() const { return static_cast<T*>(getPlugin()); }
    ...
    /**
     * @brief Return true if this step use the manual mode and it's modifiable. Use method "setManual()" and "setModifiable()" in the
    ...
    /**
     * @brief Return all results.
     */
    QList<CT_ResultGroup*> getOutResultList() const;

    /**
     * @brief Return the result at index 'n'.
     */
...
private:
    ...
    /**
     * @brief Called by CT_AbstractStepPlugin to set it was a prototype (a prototype is a class instancied only to create new instance of the same type)
     */
     ...
     */
    void removeResult(int n);

    /*!
     *  \brief Retourne la liste des résultats modèles de sortie de tous les tours
     */
    QList<CT_OutAbstractResultModel*> getOutResultModels() const;
