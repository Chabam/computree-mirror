...
/**
 * @brief Represent a step that can be added in root of the tree or in middle but not necessary load file.
 */
class PLUGINSHAREDSHARED_EXPORT CT_AbstractStepCanBeAddedFirst : public CT_AbstractStep
{
    Q_OBJECT
