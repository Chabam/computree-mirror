...
CT_IteratorGroupsModelForResultModelGroup::CT_IteratorGroupsModelForResultModelGroup(const CT_OutAbstractResultModel *resultModel)
{
    _rootTreeModels = NULL;
    _currentTreeModelsChild = NULL;

    _resultGroup = (CT_OutAbstractResultModel*)resultModel;
