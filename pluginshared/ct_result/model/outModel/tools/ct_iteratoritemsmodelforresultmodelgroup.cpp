...
CT_IteratorItemsModelForResultModelGroup::CT_IteratorItemsModelForResultModelGroup(const CT_OutAbstractResultModel* group)
{
    _rootTreeModels = NULL;
    _currentTreeModelsChild = NULL;

    _resultGroup = (CT_OutAbstractResultModel*)group;
