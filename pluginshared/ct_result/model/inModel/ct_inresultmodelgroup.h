...
public:
     ...
     * @return true if the group was set to the result.
     */
    bool setRootGroup(const QString &uniqueName,
     ...
     */
    QList<CT_AbstractResult*> searchResultsInStepForPossibilitiesSelected(const CT_VirtualAbstractStep *step) const override;
    ...
    CT_AbstractResult* searchResultsInStepForThisPossibility(const CT_VirtualAbstractStep *step,
                                                             const CT_InStdModelPossibility *possibility) const override;
