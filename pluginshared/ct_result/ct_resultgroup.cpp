...
CT_ResultGroup::CT_ResultGroup(const CT_OutAbstractResultModel &model,
                                                     ...
                                                     CT_ResultCopyModeList copyModeList)
{
    ...
    CT_ResultGroup *res = new CT_ResultGroup(*model, data, parentStep);
    res->setName(getName());
    ...
    while(it.hasNext())
    {
        CT_AbstractItemGroup *group = (CT_AbstractItemGroup*)it.next()->copy(model->rootGroup(), res, copyModeList);
