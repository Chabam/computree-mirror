...
/**
 * @brief Represent a OUTPUT model. An CT_OutAbstractModel is just a class to know that is a OUTPUT model.
 */
...
protected:
    ...
    friend class CT_OutResultModelManager;

    /**
     * @brief Called from CT_OutResultModelManager or parent model to make some
