...
void CTG_InModelPossibilitiesChoice::constructModel()
{
    ...
    if(_possibility != NULL)
    {
        ...
        CT_OutAbstractResultModel *outResModel = dynamic_cast<CT_OutAbstractResultModel*>(_possibility->outModel());
...
QList<QStandardItem*> CTG_InModelPossibilitiesChoice::createItemsForOutResultModel(CT_OutAbstractResultModel *resModel)
{
