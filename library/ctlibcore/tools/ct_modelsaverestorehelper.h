...
#include "definesettingsreader.h"
#include "definesettingswriter.h"
 ...
 */
class CTLIBMODELS_EXPORT CT_ModelSaveRestoreHelper
{
public:
    /**
     ...
     */
    static void saveSettingsOfOutModel(const QObject* caller, Models::SettingsWriter &writer, const CT_OutAbstractModel *model, const QString &modelUniqueName);
     ...
     */
    static CT_OutAbstractModel* restoreOutModelFromSettings(const QObject* caller, Models::SettingsReader& reader, const Models::Step *step, const QString &modelUniqueName, bool& savedAndFoundedOrNotSaved);
...
private:
     ...
     */
    static Models::Step* searchStepInHierarchy(const QStringList& hierarchy, const Models::Step* rootStep);
     ...
     */
    static CT_OutAbstractResultModel* searchResultModelInStep(const int& resultModelUniqueIndex, const Models::Step* pStep);
};
