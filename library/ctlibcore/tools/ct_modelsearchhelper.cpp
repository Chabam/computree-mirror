    ...
    if(model == NULL)
    {
        ...
        if(inOrOutResult->parentStep() == yourStep)
        {
            ...
            if(outCopyModel != NULL)
            {
                ...
                if((model != NULL) && (dynamic_cast<CT_OutAbstractModel*>(model)->rootOriginalModelWithAStep()->step() != yourStep)) // if no
                                                                                                              ...
                                                                                                              const CT_VirtualAbstractStep *yourStep)
{
    ...
    QList<CT_InStdModelPossibility *> itemPossibilities = itemModel->getPossibilitiesSelected();
    ...
    QList<CT_InStdModelPossibility *> attPossibilities = attModel->getPossibilitiesSelected();
