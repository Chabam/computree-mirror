...
CT_LasPointInfo* CT_LASPointFormat5::write(QDataStream &stream, CT_LASHeader* header, const CT_Point &p, const size_t &globalIndex) const
{
    CT_LasPointInfo *info = CT_LASPointFormat3::write(stream, header, p, globalIndex);
...
void CT_LASPointFormat5::writeInfoFormat5(QDataStream &stream, CT_LasPointInfo *info) const
{
