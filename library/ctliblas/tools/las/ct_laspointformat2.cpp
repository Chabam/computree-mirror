...
CT_LasPointInfo* CT_LASPointFormat2::write(QDataStream &stream, CT_LASHeader* header, const CT_Point &p, const size_t &globalIndex) const
{
...
void CT_LASPointFormat2::writeInfoFormat2(QDataStream &stream, CT_LasPointInfo *info) const
{
