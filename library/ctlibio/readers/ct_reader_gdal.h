...
private:
    ...
    QHash<QString, CT_OutStdItemAttributeModel*>    m_attrModels;
     ...
     */
    void convertGeometryToCT(OGRGeometry *poGeometry, OGRFeature *poFeature, OGRFeatureDefn *poFDefn, int layerIndex);
