...
#include "ct_delaunay2dtriangulation.h"
...
//CT_Delaunay2DTriangulation::CT_Delaunay2DTriangulation()
//{
//    _corners.resize(4);
//    _corners[0] = nullptr;
//    _corners[1] = nullptr;
...
//void CT_Delaunay2DTriangulation::clear(bool clearToInsert)
//{
//    _initialized = false;
...
//void CT_Delaunay2DTriangulation::init(double x1, double y1, double x2, double y2)
//{
//    clear(!_initialized);
...
//    // add the 4 corners
//    _corners[0] = new CT_Delaunay2DVertex (new Eigen::Vector3d(x1, y1, 0), true);
//    _corners[1] = new CT_Delaunay2DVertex (new Eigen::Vector3d(x2, y1, 0), true);
//    _corners[2] = new CT_Delaunay2DVertex (new Eigen::Vector3d(x1, y2, 0), true);
//    _corners[3] = new CT_Delaunay2DVertex (new Eigen::Vector3d(x2, y2, 0), true);
...
//bool CT_Delaunay2DTriangulation::init()
//{
//    if (_toInsert.size () < 2) {return false;}

//    for (int i = 0 ; i < _toInsert.size() ; i++)
//    {
//        CT_Delaunay2DVertex* vt = _toInsert.at(i);
...
//const QList<CT_DelaunayTriangle *> &CT_Delaunay2DTriangulation::getTriangles()
//{
//    return _triangles;
//}

//const QList<CT_Delaunay2DVertex *> &CT_Delaunay2DTriangulation::getVerticesNeighbors()
//{
...
//const QList<CT_Delaunay2DVertex *> &CT_Delaunay2DTriangulation::getVoronoiDiagram()
//{
...
//const QList<CT_Delaunay2DVertex *> &CT_Delaunay2DTriangulation::getCleanVoronoiDiagram()
//{
//    getVoronoiDiagram ();

//    for (int i = 0 ; i < _insertedVertices.size () ; i++)
//    {
//        CT_Delaunay2DVertex* v = _insertedVertices.at(i);
...
//const CT_DelaunayOutline &CT_Delaunay2DTriangulation::getOutline()
//{
//    if (_outline.getN() == 0) {
...
//QMultiMap<CT_Delaunay2DVertex *, CT_Delaunay2DVertex *> CT_Delaunay2DTriangulation::getEdges()
//{
//    QMultiMap<CT_Delaunay2DVertex *, CT_Delaunay2DVertex *> map;

//    computeVerticesNeighbors();

//    for (int i = 0 ; i < _insertedVertices.size() ; i++)
//    {
//        CT_Delaunay2DVertex *baseVertex = _insertedVertices.at(i);
//        QList<CT_Delaunay2DVertex*> &neighbours = baseVertex->getNeighbors();

//        for (int j = 0 ; j < neighbours.size() ; j++)
//        {
//            CT_Delaunay2DVertex *neighbour = neighbours.at(j);
...
//const QList<CT_Delaunay2DVertex *> &CT_Delaunay2DTriangulation::computeVerticesNeighbors()
//{
...
//    for (int i = 0 ; i < 4 ; i++)
//    {
//        QList<CT_Delaunay2DVertex*> &n = _corners.at(i)->getNeighbors();
...
//const QList<CT_Delaunay2DVertex *> &CT_Delaunay2DTriangulation::computeVoronoiDiagram()
//{


//    const QList<CT_DelaunayTriangle *> &lst = getTriangles();
//    CT_DelaunayTriangle* tri;
//    CT_Delaunay2DVertex* vert;
//    CT_Delaunay2DVertex* first;
//    CT_Delaunay2DVertex* next;
...
//const CT_DelaunayOutline& CT_Delaunay2DTriangulation::computeOutline()
//{
//    _outline.clear();

//    if (!_neighborsComputed) {computeVerticesNeighbors();}

//    QList<CT_Delaunay2DVertex*> sideVertices;
//    for (int i = 0 ; i < _corners.size() ; i++)
//    {
//         CT_Delaunay2DVertex* corner  = _corners[i];

//         QList<CT_Delaunay2DVertex*> &neighbours = corner->getNeighbors();
...
//    QVector<CT_Delaunay2DVertex*> H(2*n);
...
//CT_Delaunay2DVertex *CT_Delaunay2DTriangulation::addVertex(Eigen::Vector3d *data, bool deleteData)
//{
//    CT_Delaunay2DVertex *vt  = new CT_Delaunay2DVertex(data, deleteData);
...
//bool CT_Delaunay2DTriangulation::doInsertion(bool sort, double cellSize)
//{
...
//    CT_Delaunay2DVertex* vt;
//    CT_Delaunay2DVertex* vBase;
//    CT_Delaunay2DVertex* vNext;
//    CT_Delaunay2DVertex* vFirst;
...
//                CT_Delaunay2DVertex* sd_v1 = borderLst.getRemovedV1();
//                CT_Delaunay2DVertex* sd_v2 = borderLst.getRemovedV2();
...
//QList<CT_Delaunay2DVertex*> CT_Delaunay2DTriangulation::getNeighboursForCoordinates(double x, double y, bool cornersIncluded)
//{

//    QList<CT_Delaunay2DVertex*> neigbours;
...
//bool CT_Delaunay2DTriangulation::isCorner(CT_Delaunay2DVertex *vertex) const
//{
...
//double CT_Delaunay2DTriangulation::cross(const CT_Delaunay2DVertex *O, const CT_Delaunay2DVertex *A, const CT_Delaunay2DVertex *B)
//{
...
//void CT_Delaunay2DTriangulation::updateCornersZValues()
//{
//    if (!_neighborsComputed) {computeVerticesNeighbors();}
//    for (int i = 0 ; i < _corners.size() ; i++)
//    {
...
//CT_DelaunayTriangle* CT_Delaunay2DTriangulation::findTriangleContainingPoint(double x, double y, CT_DelaunayTriangle* refTriangle)
//{
...
//CT_DelaunayTriangle *CT_Delaunay2DTriangulation::getZCoordForXY(double x, double y, double &outZ, CT_DelaunayTriangle* refTriangle, bool cornersIncluded)
//{
...
//CT_Delaunay2DTriangulation *CT_Delaunay2DTriangulation::copy()
//{
//    CT_Delaunay2DTriangulation *cpy = new CT_Delaunay2DTriangulation();

//    cpy->init(_minx, _miny, _maxx, _maxy);

//    for (int i = 0 ; i < _insertedVertices.size() ; i++)
//    {
//        CT_Delaunay2DVertex* vertex = _insertedVertices.at(i);
