    ...
    _areaComputed(false)
{
    ...
    for (int i = 0 ; i < size ; i++)
    {
        ...
        dest = new Eigen::Vector2d(source(0), source(1));
    }
...
CT_Polygon2DData::CT_Polygon2DData(const CT_Polygon2DData &other) : SuperClass(other)
{
    _area = other._area;
    _areaComputed = other._areaComputed;
