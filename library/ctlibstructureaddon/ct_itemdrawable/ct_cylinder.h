...
private:
    ...
    CT_DEFAULT_IA_V3(CT_Cylinder, CT_AbstractCategory::staticInitDataR2(), &CT_Cylinder::getCircleError, QObject::tr("RMSE d'ajustement du cercle"), "eadc")
    CT_DEFAULT_IA_V3(CT_Cylinder, CT_AbstractCategory::staticInitDataR2(), &CT_Cylinder::getLineError, QObject::tr("RMSE d'ajustement de la ligne"), "eadl")
