...
template<typename T>
typename std::vector<ct_index_type>::const_iterator CT_CloudIndexStdVectorT<T>::vectorFindIf(typename CT_CloudIndexStdVectorT<T>::FindIfFunction findIf, void *context) const
{
    typename std::vector<ct_index_type>::const_iterator first = _vector.begin();
    typename std::vector<ct_index_type>::const_iterator last = _vector.end();
