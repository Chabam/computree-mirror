...
public slots:
    ...
    virtual void setPointOfView(double cx, double cy, double cz, double px, double py, double pz, double rx, double ry, double rz, double rw, bool redrawView = true) = 0;
};
