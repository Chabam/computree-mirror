/****************************************************************************
 ...
 Copyright (C) 2010-2011 Michael Krebs. All rights reserved.

 This file is part of Computree version 1.0.
...
QtColorPicker::QtColorPicker(QWidget *parent,
                             int cols, bool enableColorDialog, bool enableColorPopup)
    : QPushButton(parent), popup(0), withColorDialog(enableColorDialog), withColorPopup(enableColorPopup)
{
...
void QtColorPicker::buttonPressed(bool toggled)
{
    ...
    {
        _isDialogCanceled = !popup->getColorFromDialog();
    }
}
...
void QtColorPicker::showColorDialog()
{
    buttonPressed(true);
}
...
bool QtColorPicker::isDialogCanceled() const
{
    return _isDialogCanceled;
}
