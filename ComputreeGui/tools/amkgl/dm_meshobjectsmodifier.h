...
/**
 * @brief Use this class to modify mesh objects (edges/faces) in a scene or objects from a specific mesh in a scene
 */
class DM_MeshObjectsModifier : public ObjectsModifierInterface
{
public:
    /**
     * @brief Construct it
     * @param scene : the scene to modify
     * @param objectType : object type to modify. Can only be Scene::LineGlobalCloud or Scene::TriangleGlobalCloud
     * @param mesh : item to get edge/face cloud index (can be null if you want to apply modification to all edge/face of the scene)
     */
    DM_MeshObjectsModifier(const PermanentItemSceneByModel* scene,
...
#endif // DM_MESHOBJECTSMODIFIER_H
