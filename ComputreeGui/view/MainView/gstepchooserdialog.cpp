...
void GStepChooserDialog::init()
{
    ...
    connect(ui->stepChooserWidget, SIGNAL(stepDoubleClicked(CT_VirtualAbstractStep*)), this, SIGNAL(addStepToCurrentStepOrToRootAndConfigure(CT_VirtualAbstractStep*)), Qt::DirectConnection);
    connect(ui->stepChooserWidget, SIGNAL(replaceToDefault(bool)), this, SIGNAL(replaceToDefault(bool)));
...
void GStepChooserDialog::setCurrentStep(CT_VirtualAbstractStep *step)
{
    ui->stepChooserWidget->proxy()->setParentStep(step);
}
