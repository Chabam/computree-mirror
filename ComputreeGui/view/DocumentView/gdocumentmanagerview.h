...
public:
    ...
    DocumentInterface* new3DDocument(bool fromGui, bool inLoadConfigurationFromMainWindow, float pointSize = 1.0, bool orthographic = false, QColor *color = NULL);
    ...
    DocumentInterface* new3DDocument(float pointSize = 1.0, bool orthographic = false, QColor *color = NULL);
