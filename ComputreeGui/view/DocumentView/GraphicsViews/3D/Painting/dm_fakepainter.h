...
public:
    ...
    void drawLine(const size_t& globalEdgeIndex,
                  ...
                  const size_t &p2GlobalIndex) { Q_UNUSED(globalEdgeIndex) Q_UNUSED(p1GlobalIndex) Q_UNUSED(p2GlobalIndex) }
    ...
    void drawTriangle(const size_t& globalFaceIndex,
                      ...
                      const size_t &p3GlobalIndex) { Q_UNUSED(globalFaceIndex) Q_UNUSED(p1GlobalIndex) Q_UNUSED(p2GlobalIndex) Q_UNUSED(p3GlobalIndex) }
    ...
    void pushMatrix() {}
    void multMatrix(const Eigen::Matrix4d &matrix) { Q_UNUSED(matrix) }
    void popMatrix() {}
    ...
    void enableSetForcedPointSize(bool enable) { Q_UNUSED(enable) }

    void translate(const double &x, const double &y, const double &z) { Q_UNUSED(x) Q_UNUSED(y) Q_UNUSED(z) }
    void rotate(const double &alpha, const double &x, const double &y, const double &z) { Q_UNUSED(alpha) Q_UNUSED(x) Q_UNUSED(y) Q_UNUSED(z) }
    void translateThenRotateToDirection(const Eigen::Vector3d &translation, const Eigen::Vector3d &direction) { Q_UNUSED(translation) Q_UNUSED(direction) }
    void scale(const double &x, const double &y, const double &z) { Q_UNUSED(x) Q_UNUSED(y) Q_UNUSED(z) }
