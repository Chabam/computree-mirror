...
public:
    ...
    void setCurrentInternalAction(CT_AbstractActionForGraphicsView *action);
    ...
    /**
     * @brief Returns the opengl widget that represents this graphics to attach it to a layout per example or to get the opengl context
     */
    virtual QOpenGLWidget* getOpenGLWidget() const = 0;
