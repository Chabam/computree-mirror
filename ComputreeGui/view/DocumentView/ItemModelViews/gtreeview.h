...
class GTreeView : public QWidget,
        public GItemModelView,
        public DM_IItemDrawableStandardItemBuilderT<CG_CustomTreeItem>,
        public DM_ITreeViewManagerT<CG_CustomTreeItem>,
        public IColouristContextMenuAccess,
        public DM_IDocumentAddFilter
{
    Q_OBJECT
...
public:
    ...
    bool isSyncedWithAnotherDocument() const;
...
private:
    ...
    DataReferenceCollection                                                         m_dataReferencesToUse;
     ...
     */
    void recursiveAddToReferencesToUseForModel(DataReferenceCollection &uniqueReferences, const CT_OutAbstractModel *model);
