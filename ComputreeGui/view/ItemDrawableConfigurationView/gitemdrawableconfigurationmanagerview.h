...
private slots:
    ...
    /**
     * @brief User want to apply the new configuration
     */
...
signals:
    ...
    /**
     * @brief Emitted when we must apply the configuration
     */
    void applyNewConfiguration(CT_ItemDrawableConfiguration *config);
};
